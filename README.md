...
|:----|:----|:----|:----|:----|
|김지연|리더|1. 장소 검색 <br> 2. Open API 기반 음식점 정보 저장 <br> 3. 레저/티켓 예약 CRD <br> 4. 레저/티켓 결제 <br> 5. 맛집 검색|https://velog.io/@yeoni9094/posts </br> https://blog.naver.com/yeondata|https://github.com/jiyeon0926|
